...
date: 2017-07-03T14:18:13+03:00
...
Before we start, and if you are not familiar with Jest testing basics already, please make sure to cover the first part of this series, on [testing functions with Jest]( {{< relref "post/unit-testing-beginners-guide-testing-functions.md" >}} ).

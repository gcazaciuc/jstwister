...
const Hero: React.FC = () => {
  // Define the background color for the hero section
  const bgColor = useColorModeValue("pastelBg", "gray.200"); // Replace 'pastelBg' with your actual color
  ...
  return (
    ...
    >
      <VStack spacing={4}>
        ...
        <Text fontSize="xl">Web development subscriptions for everyone</Text>
        <Button
          bg="black"
          color="white"
          _hover={{ bg: "gray.700" }}
